            ...
            <div className="w-full max-w-2xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
                        <button className="group flex items-center justify-center px-4 py-3 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 hover:border-gray-300 text-gray-700 font-medium transition-all duration-200 hover:scale-105">
                        ...
                        <button className="group flex items-center justify-center px-4 py-3 bg-gray-900 hover:bg-gray-800 text-white font-medium rounded-xl transition-all duration-200 hover:scale-105">
                            <div className="w-5 h-5 mr-3 group-hover:scale-110 transition-transform duration-200">
