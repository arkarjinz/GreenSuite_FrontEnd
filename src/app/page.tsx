...
import { Star, ArrowRight, CheckCircle, Users, Zap, Shield } from 'lucide-react';
...
// Green Suite marketing content component
function GreenSuiteContent() {
  const testimonials = [
    {
      name: "Michael Chen",
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Add Green Suite marketing content below the 3D model */}
        <GreenSuiteContent />
      </main>
    </div>
  );
